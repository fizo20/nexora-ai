...
function AgentFeed() {
  ...
  return (
    <div
      className="relative rounded-2xl border border-border bg-card p-5 font-mono text-xs overflow-hidden"
      style={{ minHeight: 220 }}
    >
  ...
  return (
    <div className="bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-center pt-24 pb-20 px-6">
        {/* subtle glow — visible in dark, invisible in light (uses primary color) */}
        <div
          className="pointer-events-none absolute inset-0 overflow-hidden"
          aria-hidden
        >
          <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full opacity-10 dark:opacity-20 bg-primary blur-3xl" />
        </div>
        ...
        <div className="relative max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground max-w-[480px]">
              Nexora AI runs an autonomous agent inside your workspace —
              creating tasks, detecting gaps, and keeping your team organised
              without you lifting a finger. Built for teams that move fast and
              need intelligence that keeps up.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold bg-primary text-primary-foreground hover:opacity-90 hover:scale-[1.02] transition-all shadow-lg shadow-primary/25"
              >
                Start for free
          ...
          <div>
            ...
            <p className="mt-3 text-center text-xs text-muted-foreground">
              Live feed — this is your AI agent, working in real time
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 space-y-3">
            ...
            <p className="text-base text-muted-foreground mx-auto max-w-[520px]">
              Not another AI chatbot. Nexora runs background processes that make
              decisions and take actions — so your team can focus on what
              matters.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="rounded-2xl p-6 space-y-3 border border-border bg-card hover:border-primary/40 transition-colors"
              >
      ...
      <section id="about" className="py-24 px-6">
        <div className="max-w-4xl mx-auto rounded-3xl p-10 sm:p-16 text-center space-y-6 border border-primary/20 bg-card">
          <p className="text-xs font-bold tracking-[0.2em] uppercase text-primary">
            About Nexora
          </p>
          ...
          <p className="text-base leading-relaxed text-muted-foreground mx-auto max-w-[580px]">
          ...
          <p className="text-base leading-relaxed text-muted-foreground mx-auto max-w-[580px]">
            Our platform is API-first, enterprise-ready, and designed to
            integrate into the way you already work — not replace it.
          </p>
          <Link
            href="/register"
            className="inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-bold mt-4 bg-primary text-primary-foreground hover:opacity-90 transition-opacity"
          >
